...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style( 'animate', get_template_directory_uri().'/resources/styles/animate.css',false, null);
    wp_enqueue_style( 'lightgallery', get_template_directory_uri().'/resources/styles/lightgallery.css',false, null);
    ...
    wp_enqueue_style( 'mibreitGallery', get_template_directory_uri().'/resources/styles/mibreitGallery.css' );
    ...
    wp_enqueue_script('bootstrap', get_template_directory_uri().'/resources/scripts/bootstrap.min.js' );
    wp_enqueue_script('simply-toast', get_template_directory_uri().'/resources/scripts/simply-toast.min.js' );
    wp_enqueue_script('lightgallery', get_template_directory_uri().'/resources/scripts/lightgallery.umd.js' );
    wp_enqueue_script('lightgallery-min', get_template_directory_uri().'/resources/scripts/lightgallery.min.js' );
    wp_enqueue_script('modal', get_template_directory_uri().'/resources/scripts/modal.js' );
    wp_enqueue_script('Jpages', get_template_directory_uri().'/resources/scripts/jPages.js' );
    wp_enqueue_script('mibreitGallery', get_template_directory_uri().'/resources/scripts/mibreitGallery.min.js' );
    wp_enqueue_script('lg-thumbnail', get_template_directory_uri().'/resources/scripts/lg-thumbnail.min.js' );
