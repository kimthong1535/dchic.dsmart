    ...
    <div class="row" id="content-news">
      <div class="col-md-6 col-xs-12 row paper-first-column">
        ...
        <div class="col-md-6 col-xs-12 item first-column-title">
          <a href="/shop">
            ...
            <h6>{{ __('Xem thêm')}}<span class="border-read-more2"></span>
            </h6>
          </a>
        </div>
      </div>
      ...
      @if(have_rows('right_column')) 
        @while(have_rows('right_column')) 
          ...
          <div class="item">
            <a href="/shop">
              <img alt="BEST DRESS(ED) SEASON" src="{{ get_sub_field('right_image') }}">
            </a>
            <div class="album-title">
              <h5>{{ get_sub_field('right_title') }}</h5>
              <h6>
                <a href="/shop">{{ __('Xem thêm')}}<span class="border-read-more2"></span>
                </a>
              </h6>
            </div>
          </div>
